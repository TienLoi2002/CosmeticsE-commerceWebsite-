...
public class AdminHomeController {
    ...
    public String index(Model model) throws JsonProcessingException, ParseException {
        int sum = orderRepository.findAll().stream().mapToInt(Order::getTotalPrice).sum();
        ...
        List<Map<String, Object>> result = orderRepository.findAll()
                ...
                .collect(Collectors.groupingBy(
                        o -> o.getCreatedAt().toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime().format(DateTimeFormatter.ofPattern("d-MM")),
